# UXE - HTML Abstractions and pre-processors

For this assignment, students are required to create either a [Haml](http://haml.info/tutorial.html) or [Jade](http://jade-lang.com/reference/) document. The use of any example code is allowed, the goal is to exercise the fundamentals of the language.

Feel free to use converters to validate your code prior to submission.

* [Haml](http://www.haml-converter.com/)
* [Jade](http://html2jade.org/)
